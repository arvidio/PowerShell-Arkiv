...
$CSVdo=Import-Csv .\Documents\FNHDiariumAssocdata.csv -Delimiter "¤" -Encoding utf8NoBOM
$CSVnot=Import-CSV .\Documents\FNHDiariumAnteckningar.csv -Delimiter "¤" -Encoding utf8NoBOM
$CSVsam=Import-CSV .\Documents\FNHDiariumSamband.csv -Delimiter "¤" -Encoding utf8NoBOM
...
<mets:mets xmlns:mets="http://www.loc.gov/METS/"
           ...
           LABEL="Diarieförda ärenden Fritidsnämnden Hallstavikdistriktet, ur Ciceron Diabas"
           TYPE="ERMS"
...
Compress-Archive -Path .\Documents\Arkivexport\Paket\Leveranspaket\* -DestinationPath ".\Documents\Script\FNHDiabas$DateYYYYMMDD" -CompressionLevel Optimal -Force
