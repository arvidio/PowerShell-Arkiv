...
$CSVusr= Import-Csv .\Documents\RÄNDiariumAnvandare.csv -Delimiter "¤" -Encoding utf8NoBOM
$CSVare= Import-Csv .\Documents\RÄNDiariumArenden.csv -Delimiter "¤" -Encoding utf8NoBOM
$CSVhan= Import-CSV .\Documents\RÄNDiariumHandlingar.csv -Delimiter "¤" -Encoding utf8NoBOM
$CSVenh= Import-CSV .\Documents\RÄNDiariumEnhet.csv -Delimiter "¤" -encoding utf8NoBOM
$CSVdia= Import-CSV .\Documents\RÄNDiariumDiarieplan.csv -Delimiter "¤" -encoding utf8NoBOM
$CSVhty= Import-Csv .\Documents\RÄNDiariumHandlingstyper.csv -Delimiter "¤" -Encoding utf8NoBOM
