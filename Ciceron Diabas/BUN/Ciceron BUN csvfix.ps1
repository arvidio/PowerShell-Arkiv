...
$CSVusr= Import-Csv .\Documents\BUNDiariumAnvandare.csv -Delimiter "¤" -Encoding utf8NoBOM
$CSVare= Import-Csv .\Documents\BUNDiariumArenden.csv -Delimiter "¤" -Encoding utf8NoBOM
$CSVhan= Import-CSV .\Documents\BUNDiariumHandlingar.csv -Delimiter "¤" -Encoding utf8NoBOM
$CSVenh= Import-CSV .\Documents\BUNDiariumEnhet.csv -Delimiter "¤" -encoding utf8NoBOM
$CSVdia= Import-CSV .\Documents\BUNDiariumDiarieplan.csv -Delimiter "¤" -encoding utf8NoBOM
$CSVhty= Import-Csv .\Documents\BUNDiariumHandlingstyper.csv -Delimiter "¤" -Encoding utf8NoBOM
