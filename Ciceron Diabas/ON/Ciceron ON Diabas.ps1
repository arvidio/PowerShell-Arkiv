...
$CSVdo=Import-Csv .\Documents\ONDiariumAssocdata.csv -Delimiter "¤" -Encoding utf8NoBOM
$CSVnot=Import-CSV .\Documents\ONDiariumAnteckningar.csv -Delimiter "¤" -Encoding utf8NoBOM
$CSVsam=Import-CSV .\Documents\ONDiariumSamband.csv -Delimiter "¤" -Encoding utf8NoBOM
...
<mets:mets xmlns:mets="http://www.loc.gov/METS/"
           ...
           LABEL="Diarieförda ärenden Omsorgsnämnden, ur Ciceron Diabas."
           TYPE="ERMS"
...
Compress-Archive -Path .\Documents\Arkivexport\Paket\Leveranspaket\* -DestinationPath ".\Documents\Script\ONDiabas$DateYYYYMMDD" -CompressionLevel Optimal -Force
