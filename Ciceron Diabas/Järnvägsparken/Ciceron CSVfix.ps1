...
$CSVusr= Import-Csv C:\Users\97arer14\Documents\JVPAnvändare.csv -Delimiter ";" -Encoding utf8BOM
$CSVare= Import-Csv C:\Users\97arer14\Documents\JVPCases3.csv -Delimiter ";" -Encoding utf8BOM
$CSVhan= Import-CSV C:\Users\97arer14\Documents\JVPHandlingar2.csv -Delimiter ";" -Encoding utf8BOM
$CSVenh= Import-CSV C:\Users\97arer14\Documents\JVPEnhet.csv -Delimiter ";" -encoding utf8BOM
$CSVdia= Import-CSV C:\Users\97arer14\Documents\JVPDiarieplaner.csv -Delimiter ";" -encoding utf8BOM
$CSVhty= Import-Csv C:\Users\97arer14\Documents\JVPhandlingstyper.csv -Delimiter ";" -Encoding utf8BOM
...
foreach($dpl in $CSVdia){
    ...
    foreach($arende in $CSVare){
        ...
        #Detta skapar problem. -match tar för 315 med 15, 31 osv... Prova med eq istället
