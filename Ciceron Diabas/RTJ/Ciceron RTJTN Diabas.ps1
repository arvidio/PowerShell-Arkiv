...
$CSVdo=Import-Csv .\Documents\RTJTNDiariumAssocdata.csv -Delimiter "¤" -Encoding utf8NoBOM
$CSVnot=Import-CSV .\Documents\RTJTNDiariumAnteckningar.csv -Delimiter "¤" -Encoding utf8NoBOM
$CSVsam=Import-CSV .\Documents\RTJTNDiariumSamband.csv -Delimiter "¤" -Encoding utf8NoBOM
...
Compress-Archive -Path .\Documents\Arkivexport\Paket\Leveranspaket\* -DestinationPath ".\Documents\Script\RTJTNDiabas$DateYYYYMMDD" -CompressionLevel Optimal -Force
