...
$CSVusr= Import-Csv .\Documents\SNDiariumAnvandare.csv -Delimiter "♥" -Encoding utf8NoBOM
$CSVare= Import-Csv .\Documents\SNDiariumArenden.csv -Delimiter "♥" -Encoding utf8NoBOM
$CSVhan= Import-CSV .\Documents\SNDiariumHandlingar.csv -Delimiter "♥" -Encoding utf8NoBOM
$CSVenh= Import-CSV .\Documents\SNDiariumEnhet.csv -Delimiter "♥" -encoding utf8NoBOM
$CSVdia= Import-CSV .\Documents\SNDiariumDiarieplan.csv -Delimiter "♥" -encoding utf8NoBOM
$CSVhty= Import-Csv .\Documents\SNDiariumHandlingstyper.csv -Delimiter "♥" -Encoding utf8NoBOM
