...
$CSVusr= Import-Csv .\Documents\FORVAnvandare.csv -Delimiter "♥" -Encoding utf8NoBOM
$CSVare= Import-Csv .\Documents\FORVArenden.csv -Delimiter "♥" -Encoding utf8NoBOM
$CSVhan= Import-CSV .\Documents\FORVHandlingar.csv -Delimiter "♥" -Encoding utf8NoBOM
$CSVenh= Import-CSV .\Documents\FORVEnhet.csv -Delimiter "♥" -encoding utf8NoBOM
$CSVdia= Import-CSV .\Documents\FORVDiarieplan.csv -Delimiter "♥" -encoding utf8NoBOM
$CSVhty= Import-Csv .\Documents\FORVHandlingstyp.csv -Delimiter "♥" -Encoding utf8NoBOM
