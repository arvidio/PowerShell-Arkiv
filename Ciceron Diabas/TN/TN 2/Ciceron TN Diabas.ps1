...
$CSVdo=Import-Csv .\Documents\TNDiariumAssocdata.csv -Delimiter "¤" -Encoding utf8NoBOM
$CSVnot=Import-CSV .\Documents\TNDiariumAnteckningar.csv -Delimiter "¤" -Encoding utf8NoBOM
$CSVsam=Import-CSV .\Documents\TNDiariumSamband.csv -Delimiter "¤" -Encoding utf8NoBOM
...
Compress-Archive -Path .\Documents\Arkivexport\Paket\Leveranspaket\* -DestinationPath ".\Documents\Script\TNDiabas$DateYYYYMMDD" -CompressionLevel Optimal -Force
